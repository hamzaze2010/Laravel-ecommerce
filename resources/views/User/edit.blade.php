            ...
            <div class="card-header pb-0">
              <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                <a class="w-auto pl-0" href="/index.html">
                  <img src="{{ asset('admin/images/user.png') }}" alt="Admin" width="50" height="50">
                  <span class="brand-name text-dark">User Registration</span>
                </a>
              </div>
            </div>
              ...
              <form method="POST" action="{{ route('user_register') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="password" name="password_confirmation" class="form-control input-lg" id="password_confirmation" required>
                  </div>
                  <div class="form-group col-md-12 mb-4">
                    <label for="phone">Phone</label>
                    <input type="tel" name="phone" class="form-control input-lg" id="phone">
                  </div>
                  <div class="form-group col-md-12 mb-4">
                  ...
                  <div class="col-md-12">
                    ...
                    <p>Already have an account?
                      <a class="text-blue" href="{{ route('userLogin') }}">Sign In</a>
                    </p>
                  </div>
                </div>
              </form>
