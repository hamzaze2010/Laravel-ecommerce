            ...
            <div class="sidebar-left" data-simplebar style="height: 100%;">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li
                   ...
                   >
                    <a class="sidenav-item-link" href="{{route('adminManage')}}">
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="{{ route('categoryManage') }}">
                 ...
                 <li
                   >
                    <a class="sidenav-item-link" href="{{ route('productManage') }}">
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="{{ route('userManage') }}">
                  ...
                  <li>
                  <a class="sidenav-item-link" href="{{ route('admin.order.manage') }}">
