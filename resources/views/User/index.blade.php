@include('User.header');
 ...
 <section class="categories">
    <div class="container-fluid">
        <div class="row">
            @foreach($categorys->take(5) as $index => $category)
                @if($index == 0)
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <ul class="filter__controls">
                        ...
                        <li data-filter=".{{ strtolower($category->name) }}">
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset('storage/' . $product->image) }}">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="javascript:void(0);" id="add-to-wishlist" data-product-id="{{ $product->id }}"><span class="icon_heart_alt"></span></a></li>
                                <li>
